...
// Flush provides a mock function for the type Backend
func (_mock *Backend) Flush() error {
	ret := _mock.Called()
...
func (_c *Backend_Flush_Call) Return(err error) *Backend_Flush_Call {
	_c.Call.Return(err)
	return _c
}
...
func (_mock *Backend) Get(key string) (httpcache.Entry, bool) {
	...
	var r1 bool
	if returnFunc, ok := ret.Get(0).(func(string) (httpcache.Entry, bool)); ok {
		return returnFunc(key)
	}
	if returnFunc, ok := ret.Get(0).(func(string) httpcache.Entry); ok {
		r0 = returnFunc(key)
	} else {
...
func (_c *Backend_Get_Call) Return(entry httpcache.Entry, b bool) *Backend_Get_Call {
	_c.Call.Return(entry, b)
	return _c
}

func (_c *Backend_Get_Call) RunAndReturn(run func(key string) (httpcache.Entry, bool)) *Backend_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Purge provides a mock function for the type Backend
func (_mock *Backend) Purge(key string) error {
	ret := _mock.Called(key)
...
func (_c *Backend_Purge_Call) Return(err error) *Backend_Purge_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Backend_Purge_Call) RunAndReturn(run func(key string) error) *Backend_Purge_Call {
	_c.Call.Return(run)
	return _c
}

// Set provides a mock function for the type Backend
func (_mock *Backend) Set(key string, entry httpcache.Entry) error {
	ret := _mock.Called(key, entry)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(string, httpcache.Entry) error); ok {
		r0 = returnFunc(key, entry)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_c *Backend_Set_Call) Run(run func(key string, entry httpcache.Entry)) *Backend_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 httpcache.Entry
		if args[1] != nil {
			arg1 = args[1].(httpcache.Entry)
		}
		run(
			arg0,
			arg1,
...
func (_c *Backend_Set_Call) Return(err error) *Backend_Set_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Backend_Set_Call) RunAndReturn(run func(key string, entry httpcache.Entry) error) *Backend_Set_Call {
	_c.Call.Return(run)
	return _c
}
